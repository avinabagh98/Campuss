...
export default function UserView() {
    ...
    const stats = [
        { key: 'total', label: 'TOTAL', value: attendanceData?.length || 0, icon: faUser, color: Colours.brand.primary },
                ...
                <TouchableOpacity activeOpacity={0.6}>
                    <View style={styles.attRow}>
                        ...
                        <View style={styles.attInfo}>
                            ...
                            <Text style={styles.attMeta}>{item.Course}</Text>
                        </View>
    ...
    const ListHeader = () => (
        <>
            <Text style={styles.heading}>ABC College</Text>
            ...
            <View style={styles.statsRow}>
                {stats.map(s => (
                    <Card key={s.key} style={styles.statCard}>
                        <FontAwesomeIcon icon={s.icon} size={24} color={s.color} />
            ...
            <View style={styles.sectionHeader}>
                ...
                <TouchableOpacity style={styles.seeAll} onPress={() => setOpen(true)}>
                    <FontAwesomeIcon icon={faFilter} color={Colours.brand.primaryLight} />
                    <Text style={{ color: Colours.brand.primary, marginLeft: 6 }}>Filter</Text>
                </TouchableOpacity>
            </View>
        </>
    );
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#f6f7fb' }}>
            ...
            <TouchableOpacity
                ...
                onPress={sync}
            >
                <FontAwesomeIcon icon={faSync} color={Colours.text.white} />
            </TouchableOpacity>
